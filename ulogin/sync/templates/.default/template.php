...
<style>
    ...
    <div class="profile-link profile-user-div-link">Аккаунты социальных сетей</div>

    <div class="profile-link profile-user-div-link"> Синхронизация аккаунтов:</div>
    <div class="ulogin_synchronisation">
        <?php echo $arResult['ULOGIN_CODE']; ?>
    </div>
    <div class="ulogin-title-grey">
        Привяжите ваши аккаунты соц. сетей к личному кабинету для быстрой авторизации через любой из них<br><br>
    </div>

    <div class="profile-link profile-user-div-link">Привязанные аккаунты:</div>
    <div id="ulogin_synchronisation">
        <?php echo $arResult['ULOGIN_SYNC']; ?>
    </div>
    <div class="ulogin-title-grey">
        Вы можете удалить привязку к аккаунту, кликнув по значку<br><br>
    </div>
